...
float duration, distance, duration1, distance1, duration2, distance2, duration3, distance3, duration4, distance4, duration5, distance5, duration6, distance6;
...
//******Please input the code of your approaches/algorithms in the below area*****************//
  ...
  {  
    setVehicle(90,90); //Call the setVehicle function to set the vehicle steering and velocity(speed) values
  }
 
  if(distance3 > 20 || distance4 > 20) //Greater than safety distance, run the vehicle
  {  
    setVehicle(90,100);
    if (distance2<32 || distance1 <32){
    setVehicle(110,100);
